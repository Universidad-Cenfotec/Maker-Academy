# Checklist de organización de Show Your Work

> Este archivo pertenece a: **Maker Academy**  
> Ruta: `11. Comunidad Show Your Work/Checklist de organización.md`
...
- [ ] Definir el horario.
- [ ] Reservar el espacio.
- [ ] Confirmar los niveles participantes.
- [ ] Estimar la cantidad de proyectos.
- [ ] Estimar la cantidad de visitantes.
- [ ] Seleccionar el formato general.
- [ ] Elegir el nombre o tema del evento.
- [ ] Nombrar a la persona coordinadora.
- [ ] Seleccionar representantes estudiantiles.
...
- [ ] Confirmar los proyectos participantes.
- [ ] Permitir que cada equipo elija cómo desea presentar.
- [ ] Diseñar las estaciones con participación estudiantil.
- [ ] Definir el nombre de cada estación.
- [ ] Preparar las demostraciones o actividades.
- [ ] Seleccionar fotografías, bocetos y evidencias.
- [ ] Definir qué podrán hacer los visitantes.
- [ ] Preparar una pregunta para el público.
- [ ] Identificar las necesidades de electricidad.
- [ ] Identificar las necesidades de internet.
- [ ] Identificar los proyectos que requieren supervisión especial.

---

## Preparación estudiantil

- [ ] Distribuir los roles dentro de cada equipo.
- [ ] Practicar las presentaciones.
- [ ] Ensayar las actividades para visitantes.
...
- [ ] Proteger los cables.
- [ ] Confirmar el acceso a electricidad.
- [ ] Confirmar el acceso a internet.
- [ ] Preparar el punto de bienvenida.
...
- [ ] Preparar la bienvenida.
- [ ] Explicar cómo recorrer las estaciones.
...
- [ ] Confirmar los permisos para fotografías y videos.
- [ ] Asignar responsabilidades de registro.
- [ ] Tomar fotografías de las estaciones.
- [ ] Registrar a las personas estudiantes organizando y presentando.
- [ ] Grabar videos breves.
- [ ] Preparar entrevistas o testimonios.
- [ ] Registrar la cantidad aproximada de visitantes.
- [ ] Recopilar comentarios.
- [ ] Documentar las decisiones estudiantiles.
- [ ] Registrar los roles asumidos.
...
- [ ] Realizar una reflexión con las personas estudiantes.
- [ ] Comparar los resultados con los criterios de éxito.
- [ ] Recopilar la opinión de los equipos organizadores.
- [ ] Identificar las decisiones estudiantiles que funcionaron mejor.
...
Este checklist es una **propuesta de referencia** y puede modificarse según las características, recursos, edades, cantidad de participantes y condiciones de cada centro educativo.

No es necesario implementar todos los equipos, actividades o formatos sugeridos. El personal docente puede seleccionar, combinar o adaptar los elementos que resulten pertinentes.
