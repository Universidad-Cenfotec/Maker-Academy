...
> Ruta: `01. Bloques Temáticos/05. Robótica/06. Evaluación/README.md`
...
Dentro de Maker Academy, evaluar en robótica no significa solo revisar si el robot "funciona". Significa observar el proceso completo: seguridad, armado, comprensión conceptual, programación, uso de sensores, colaboración y comunicación del proceso. Estos instrumentos permiten al docente dar seguimiento a ese proceso de forma consistente entre sesiones, grupos y años lectivos, en línea con la cultura maker de aprender haciendo y documentar el camino, no solo el resultado.
...
Ningún instrumento de esta carpeta busca reemplazar la observación directa del docente en el makerspace. Están diseñados para ordenar esa observación y hacerla consistente entre sesiones, no para convertir la evaluación en un trámite mecánico. Se recomienda compartir los criterios con los estudiantes antes de iniciar cada proyecto, y usar los instrumentos también como autoevaluación o coevaluación entre equipos, no solo como herramienta exclusiva del docente.
