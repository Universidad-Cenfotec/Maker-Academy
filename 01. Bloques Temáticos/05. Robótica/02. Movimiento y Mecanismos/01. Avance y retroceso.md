...
> Ruta: `01. Bloques Temáticos/05. Robótica/02. Movimiento y Mecanismos/01. Avance y retroceso.md`
...
Esto no es un defecto del kit: es una propiedad real de los motores DC. La solución es la calibración de velocidades, que se cubre en el archivo `04. Calibración de motores.md`.
