...
* [ ] [Material 3, ej: Cables de conexión, cartón, tijeras]
...
1. **Paso 1 (Construcción):** [Instrucción clara de armado técnico o físico].
   * *Tip:* [Consejo visual o técnico útil, ej: cuidado con la polaridad del LED].
2. **Paso 2 (Programación):** [Instrucción de código, bloques o lógica computacional].
3. **Paso 3 (La Prueba):** Poné a prueba tu prototipo. ¿Hace lo que esperabas? Si encontrás un fallo, ¡iterá y mejoralo!
...
* **Mi Bitácora Maker:** Respondé estas preguntas clave para guardar tu evidencia:
...
* <a href="https://docs.google.com/document/d/1nkUbGxYXh-ajeJ9gHeLngMeNEmCDqfPywKFHfbCtQR8/edit?usp=sharing"_blank">🚀 Plantilla: Guía del Estudiante (XperiencED Kids)</a>
